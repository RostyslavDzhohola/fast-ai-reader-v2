...
async function scrollToBottom() {
    try {
        ...
        const scroller = document.querySelector('div[class*="scroller"][class*="customTheme"][class*="auto"]');
        if (!scroller) {
...
async function extractMessagesFromDiscord(count) {
    const messages = [];
    ...
    async function triggerMessageLoad() {
        try {
            // Updated selector to match Discord's current class names
            const scroller = document.querySelector('div[class*="scroller"][class*="customTheme"][class*="auto"]');
            if (!scroller) {
        ...
        try {
            ...
            if (clearButton) {
                ...
                setTimeout(() => {
                    ...
                    const editorContent = document.querySelector('div[class*="searchBar_"] div[class*="DraftEditor-content"]');
                    if (!editorContent) {
